# Default ZIM html export template with new checkboxes
...
If you want to use these checkbox icons in your own template, you can copy the css to your template, replacing the original ones.
